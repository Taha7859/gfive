...
export default function HoverButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`relative inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter rounded-md group transition-all duration-300 ${className}`}
    >
