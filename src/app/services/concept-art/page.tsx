...
export default function ConceptArtPage() {
  ...
  // Fetch Concept Art Characters dynamically
  useEffect(() => {
    const fetchConceptArt = async () => {
      setLoading(true);
      try {
        const query = `*[_type=="characterDesign" && lower(category) == "conceptartcharacters"]
        ...
        console.error("Error fetching Concept Art characters:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <>
      <Head>
  <title>Concept Art | shpfusion.com</title>
  <meta
    name="description"
    content="Explore stunning Concept Art Characters — Premium, Standard, and Basic designs by shpfusion.com. Fully dynamic, fast loading, and SEO optimized."
  />
  <meta
    name="keywords"
    content="Concept Art, shpfusion.com, Premium Concept Art, Standard Concept Art, Basic Concept Art, character designs"
  />
      ...
      <div className="min-h-screen bg-white select-none text-gray-900">
        ...
        <div className="p-6 pt-28">
          {loading ? (
            ...
            <p className="text-center text-gray-500">No Concept Art found</p>
          ) : (
