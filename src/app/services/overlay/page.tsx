    ...
    const fetchOverlays = async () => {
      ...
      try {
        const query = `*[_type=="streamgraphics" &&
          lower(category)=="overlay" &&
          lower(subType)==lower($sub)
  ...
  return (
    <>
      <Head>
        <title>
          {activeSub === "static"
            ? "Static Overlays | ShopFusion"
            : "Animated Overlays | ShopFusion"}
        </title>
        <meta
          name="description"
          content="High-quality overlays for streamers. Premium, Standard and Basic overlays on ShopFusion."
        />
        <meta
          name="keywords"
          content="stream overlays, animated overlays, static overlays, ShopFusion overlays"
        />
      </Head>
