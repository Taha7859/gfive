...
export default function DndPage() {
  ...
  // Fetch DnD characters dynamically
  useEffect(() => {
    const fetchDnd = async () => {
      setLoading(true);
      try {
        const query = `*[_type=="characterDesign" && lower(category) == "dnd"] 
  ...
  return { ...item, label };
        ...
        console.error("Error fetching DnD characters:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <>
      <Head>
        <title>DnD Characters | shpfusion.com</title>
        <meta
          name="description"
          content="Explore high-quality DnD character designs — Premium, Standard, and Basic by shpfusion.com. Fully dynamic, fast loading, and SEO optimized."
        />
        <meta
          name="keywords"
          content="DnD characters, shpfusion.com, Premium DnD, Standard DnD, Basic DnD, character art"
        />
      ...
      <div className="min-h-screen bg-white select-none text-gray-900">
        ...
        <div className="p-6 pt-28">
          {loading ? (
            ...
            <p className="text-center text-gray-500">No DnD characters found</p>
          ) : (
