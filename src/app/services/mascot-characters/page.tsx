...
export default function MascotCharactersPage() {
  ...
  // Fetch Mascot characters from Sanity
  useEffect(() => {
    const fetchMascot = async () => {
      try {
        setLoading(true);
        const query = `
          *[_type=="characterDesign" && lower(category)=="mascotcharacters"]
  ...
  return (
    <>
      <Head>
        <title>Mascot Characters | Moon Designs</title>
        <meta
          name="description"
          content="Explore high-quality Mascot character designs — Premium, Standard, and Basic by Moon Designs. Dynamic pricing from Sanity CMS."
        />
        <meta
          name="keywords"
          content="Mascot Characters, Moon Designs, Premium Mascot, Standard Mascot, Basic Mascot, character design"
        />
      </Head>
      ...
      <div className="min-h-screen bg-white select-none text-gray-900">
        ...
        <div className="p-6 pt-28">
          {loading ? (
            ...
            <p className="text-center text-gray-500">No Mascot characters found</p>
          ) : (
