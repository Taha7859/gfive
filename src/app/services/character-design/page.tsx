...
export default function AnimePage() {
  ...
  useEffect(() => {
    const fetchAnime = async () => {
      try {
        setLoading(true);
        const query = `
          *[_type=="characterDesign" && lower(category)=="anime"]
  ...
  return (
    <>
      <Head>
        <title>Anime Characters | Moon Designs</title>
        <meta
          name="description"
          content="Explore high-quality anime characters — Premium, Standard, and Basic designs by Moon Designs. Dynamic pricing from Sanity CMS."
        />
        <meta
          name="keywords"
          content="Anime Characters, Moon Designs, Premium Anime, Standard Anime, Basic Anime, character design"
        />
      </Head>
      ...
      <div className="min-h-screen bg-white select-none text-gray-900">
        ...
        <div className="p-6 pt-28">
          {loading ? (
            ...
            <p className="text-center text-gray-500">No Anime characters found</p>
          ) : (
