            ...
            <div>
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-[#2b2738] text-white placeholder-gray-400 rounded-lg px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-[#9f7aea] border transition ${
                    confirmPassword
                      ? passwordsMatch
                        ? "border-green-500"
                        : "border-red-500"
